...
class ScorePagePortrait extends ConsumerStatefulWidget {
  final List<PlayerModel> selectedPlayers;
  const ScorePagePortrait({
    Key? key,
...
class _ScorePageState extends ConsumerState<ScorePagePortrait> {
                ...
                child: Align(
                  ...
                  child: DecoratedBox(
                    decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: ColorConstants.secondaryTextColor),
