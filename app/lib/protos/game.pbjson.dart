...
final $typed_data.Uint8List saveGameReplyDescriptor = $convert.base64Decode('Cg1TYXZlR2FtZVJlcGx5');
...
const GameModel$json = const {
  ...
  '2': const [
    ...
    const {'1': 'sets', '3': 4, '4': 3, '5': 11, '6': '.base.SetModel', '10': 'sets'},
  ],
};

/// Descriptor for `GameModel`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gameModelDescriptor = $convert.base64Decode('CglHYW1lTW9kZWwSHAoJdGltZVN0YW1wGAEgASgDUgl0aW1lU3RhbXASIAoLaG9tZVRlYW1JZHMYAiADKAVSC2hvbWVUZWFtSWRzEiAKC2F3YXlUZWFtSWRzGAMgAygFUgthd2F5VGVhbUlkcxIiCgRzZXRzGAQgAygLMg4uYmFzZS5TZXRNb2RlbFIEc2V0cw==');
