...
final $typed_data.Uint8List registerExternalRequestDescriptor =
    $convert.base64Decode(
        'ChdSZWdpc3RlckV4dGVybmFsUmVxdWVzdBIzCgtwbGF5ZXJNb2RlbBgBIAEoCzIRLmJhc2UuUGxheWVyTW9kZWxSC3BsYXllck1vZGVs');
...
final $typed_data.Uint8List registerExternalReplyDescriptor = $convert.base64Decode(
    'ChVSZWdpc3RlckV4dGVybmFsUmVwbHkSMwoLcGxheWVyTW9kZWwYASABKAsyES5iYXNlLlBsYXllck1vZGVsUgtwbGF5ZXJNb2RlbA==');
...
final $typed_data.Uint8List getPlayersRequestDescriptor =
    $convert.base64Decode('ChFHZXRQbGF5ZXJzUmVxdWVzdA==');
...
final $typed_data.Uint8List getPlayersReplyDescriptor = $convert.base64Decode(
    'Cg9HZXRQbGF5ZXJzUmVwbHkSMwoLcGxheWVyTW9kZWwYASADKAsyES5iYXNlLlBsYXllck1vZGVsUgtwbGF5ZXJNb2RlbA==');
...
final $typed_data.Uint8List updatePlayerRequestDescriptor = $convert.base64Decode(
    'ChNVcGRhdGVQbGF5ZXJSZXF1ZXN0EhoKCHBsYXllcklkGAEgASgJUghwbGF5ZXJJZBIzCgtwbGF5ZXJNb2RlbBgCIAEoCzIRLmJhc2UuUGxheWVyTW9kZWxSC3BsYXllck1vZGVs');
...
final $typed_data.Uint8List updatePlayerReplyDescriptor = $convert.base64Decode(
    'ChFVcGRhdGVQbGF5ZXJSZXBseRIzCgtwbGF5ZXJNb2RlbBgBIAEoCzIRLmJhc2UuUGxheWVyTW9kZWxSC3BsYXllck1vZGVs');
